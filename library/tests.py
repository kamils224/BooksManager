...
class BookViewsTestCase(TestCase):
    ...
    def test_context_books_count(self):
        response = self.client.get('/')
    ...
    def test_filters_min_date(self):
    ...
    def test_filters_max_date(self):
    ...
    def test_library_create_get(self):
        response = self.client.get('/library/create/')
        self.assertEqual(response.status_code, HTTPStatus.OK)

    def test_library_create_post(self):
    ...
    def test_library_update_get(self):
        response = self.client.get('/library/update/1')
        self.assertEqual(response.status_code, HTTPStatus.OK)

    def test_library_update_post(self):
    ...
    def test_library_update_fail(self):
        response = self.client.get('/library/update/')
        self.assertEqual(response.status_code, HTTPStatus.NOT_FOUND)

    def test_library_delete_get(self):
    ...
    def test_library_delete_fail(self):
